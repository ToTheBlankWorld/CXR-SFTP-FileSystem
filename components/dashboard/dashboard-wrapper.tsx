    ...
    <div className="relative flex flex-col flex-1 min-h-screen overflow-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 pt-4 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="relative bg-background/95 border border-border/50 rounded-2xl shadow-lg shadow-black/5 transition-shadow duration-200 hover:shadow-xl hover:shadow-black/10">
